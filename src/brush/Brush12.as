package brush
{
	...
	public class Brush12 extends Brush
	{
		public function Brush12()
		{
			super();
...
//			}
			...
			L0Sin0 = 10*sin0;//lastThickness*sin0;
			L0Cos0 = 10*cos0;//lastThickness*cos0;
			L1Sin1 = 10*sin1;//lineThickness*sin1;
			L1Cos1 = 10*cos1;//lineThickness*cos1;
...
//			}
			...
			graphics.lineStyle(1,darkenColor(sampleColor, 0.1), alpha);
